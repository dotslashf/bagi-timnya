...
const Card = ({players, teamName, emoji, ...props}: Card) => {
    return (
        <div className="flex flex-col group" {...props}>
            <div
                className="flex items-center justify-between rounded-t-lg border p-3 sm:px-6 sm:py-4 shadow-sm z-10 bg-slate-100 group-hover:bg-slate-200 transition-colors">
